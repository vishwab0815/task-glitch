...
function AppContent() {
  const { loading, error, metrics, derivedSorted, addTask, updateTask, deleteTask, undoDelete, lastDeleted, dismissLastDeleted } = useTasksContext();
  const handleCloseUndo = () => dismissLastDeleted();
